...
//                    BidirectionalSlider(value: $sliderValue, minValue: 0, maxValue: songDuration)
//                }
                ...
                CustomSlider(value: $sliderValue, maxValue: songDuration)
                    .frame(height: 15)
//                    .opacity((songDuration == 1) ? 0.0 : 1.0)
//                
//                CustomSlider(value: $sliderValue, maxValue: songDuration,
//                       onEditingChanged: {
//                    sliderBeingDragged in
...
//                    .offset(x: CGFloat(value/maxValue - 0.5) * geometry.size.width)
            }
        }
    }
}
...
struct BidirectionalSlider: View {
    ...
    public let minValue: Double // = -50
    public let maxValue: Double // = 50
    private let thumbRadius: CGFloat = 12
